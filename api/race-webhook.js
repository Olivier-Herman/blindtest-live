...
const BOARD = [
  ...
  { id: 3,  type: 'normal' },
  { id: 4,  type: 'normal' },
  { id: 5,  type: 'trap',   value: -2 },
  { id: 6,  type: 'normal' },
  { id: 7,  type: 'duel'   },
  { id: 8,  type: 'normal' },
  { id: 9,  type: 'normal' },
  { id: 10, type: 'bonus',  value: 2  },
  { id: 11, type: 'normal' },
  { id: 12, type: 'trap',   value: -3 },
  { id: 13, type: 'normal' },
  { id: 14, type: 'joker'  },
  { id: 15, type: 'normal' },
  { id: 16, type: 'bonus',  value: 3  },
  { id: 17, type: 'normal' },
  { id: 18, type: 'normal' },
  { id: 19, type: 'trap',   value: -2 },
  { id: 20, type: 'normal' },
  { id: 21, type: 'duel'   },
  { id: 22, type: 'normal' },
  { id: 23, type: 'bonus',  value: 2  },
  { id: 24, type: 'normal' },
  { id: 25, type: 'trap',   value: -3 },
  { id: 26, type: 'joker'  },
  { id: 27, type: 'normal' },
  { id: 28, type: 'duel'   },
  { id: 29, type: 'bonus',  value: 2  },
  { id: 30, type: 'finish' },
]
...
module.exports = async (req, res) => {
  ...
  // Joueur bloqué — consomme le blocage
  ...
  if (landedCase.type === 'bonus') {
    ...
    // Bloque le joueur en tête (pas le joueur actuel)
  ...
  await supabase.from('race_players').update({
    position: newPos,
    last_answered_round: state.round_number,
    is_blocked: false
  }).eq('id', player.id)

  // Met à jour race_state
